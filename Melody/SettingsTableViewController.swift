...
class SettingsTableViewController: UITableViewController {
    ...
    lazy var settings: SettingsDictionary = [
        ...
        .init(1, 2): .init(title: "Library Refresh", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(1, 3): .init(title: "Tab Bar", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(1, 4): .init(title: "Gestures", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(1, 5): .init(title: "Artwork", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(1, 6): .init(title: "Background", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(1, 7): .init(title: "App Icon", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(1, 8): .init(title: "Theme", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(2, 0): .init(title: "Queue", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(2, 1): .init(title: "Playback", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(2, 2): .init(title: "Fullscreen Player", accessoryType: .chevron(tap: nil, preview: nil)),
        ...
        .init(4, 3): .init(title: "Secondary Song Info", accessoryType: .chevron(tap: nil, preview: nil)),
        .init(4, 4): .init(title: "Recents", accessoryType: .chevron(tap: nil, preview: nil)),
