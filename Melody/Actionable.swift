...
extension SongActionable {
        ...
        var selection: [UIAlertAction] {
            ...
            if sender is UIButton, let container = self as? EntityContainer {
                ...
                return [UIAlertAction.init(title: "End Editing", style: .default, handler: { [weak self] action in
                    ...
                    guard container.tableView.isEditing else { return }
                    
                    self?.songManager.toggleEditing(action)
                })]
            }
    ...
    func alertActions(from vc: UIViewController) -> [UIAlertAction] {
        
        return applicableActions.map({ alertAction(for: $0, from: vc, using: actionableSongs, alternateTitle: vc is InfoViewController) })
    }
    
    func alertAction(for action: SongAction, from vc: UIViewController, using array: [MPMediaItem], alternateTitle: Bool = false) -> UIAlertAction {
    ...
    func actionDetails(for action: SongAction, from vc: UIViewController, using array: [MPMediaItem], alternateTitle: Bool) -> ActionDetails {
        ...
        switch action {
            ...
            case .collect:
                ...
                return (title: alternateTitle ? "Collector" : "Collect", style: .default, {
            ...
            case .addTo:
                ...
                return (title: alternateTitle ? "Existing Playlist..." : "Add to Playlist...", style: .default, handler: {
            ...
            case .newPlaylist:
                ...
                return (title: alternateTitle ? "New Playlist..." : "Create Playlist...", style: .default, handler: {
            ...
            case .remove:
                ...
                return (title: "All", style: .destructive, handler: {
            ...
            case .library:
                ...
                return (title: alternateTitle ? "Library" : "Add to Library", style: .default, handler: {
            ...
            case .queue(name: let name, query: _):
                ...
                return (title: "Queue...", style: .default, {
            ...
            case .info:
                ...
                return (title: alternateTitle ? "Info" : "Get Info", style: .default, {
...
extension SingleItemActionable {
    ...
    func singleItemAlertAction(for action: SongAction, entity: Entity, using item: MPMediaEntity, from vc: UIViewController, useAlternateTitle alternateTitle: Bool = false) -> UIAlertAction {
    ...
    func singleItemActionDetails(for action: SongAction, entity: Entity, using item: MPMediaEntity, from vc: UIViewController, useAlternateTitle alternateTitle: Bool = false) -> ActionDetails {
        ...
        switch action {
            ...
            case .collect:
                ...
                return (title: "Collect", style: .default, {
            ...
            case .addTo:
                ...
                return (title: "Add to Playlist...", style: .default, handler: {
            ...
            case .newPlaylist:
                ...
                return (title: "Create Playlist...", style: .default, handler: {
            ...
            case .remove:
                ...
                return (title: "Remove All", style: .destructive, handler: {
            ...
            case .library:
                ...
                return (title: "Add to Library", style: .default, handler: {
            ...
            case .queue(name: let name, query: let query):
                ...
                return (title: "Queue...", style: .default, {
                    ...
                    var context: QueueInsertViewController.Context {
            ...
            case .info(let context):
                ...
                return (title: "\(alternateTitle.inverted ? "Get " : "")Info", style: .default, {
            ...
            case .show(title: let title, context: let context):
                ...
                return (title: "Show...", style: .default, {
            ...
            case .rate:
                ...
                return (title: "Rate...", style: .default, {
                    
                    guard let song = item as? MPMediaItem else { return }
                    
                    let actions = Array(0...5).map({ value in
                        
                        UIAlertAction.init(title: value == 0 ? "Unrated" : "\(value) stars", style: .default, handler: { _ in
                    ...
                    vc.present(UIAlertController.withTitle(song.validTitle, message: "Rate...", style: .actionSheet, actions: actions + [.cancel()]), animated: true, completion: nil)
                })
            
            case .likedState:
            
                return (title: "Like...", style: .default, {
                    
                    guard let settable = item as? Settable else { return }
                    
                    let actions = [.none, LikedState.liked, .disliked].map({ (value) -> UIAlertAction in
            ...
            case .reveal(indexPath: let indexPath):
                ...
                return (title: "Reveal", style: .default, {
            ...
            case .insert(items: let items, completions: let completions):
                ...
                return (title: "Insert", style: .default, {
            ...
            case .play(title: let title, completion: let completion):
                ...
                return (title: "Play", style: .default, {
            ...
            case .shuffle(mode: let mode, title: let title, completion: let completion):
                ...
                return (title: .shuffle(alternateTitle ? .none : mode), style: .default, {
